    ...
    return ClipRRect(
      ...
      child: Container(
          ...
          child: Row(children: [
            ...
            _GlassCircleButton(icon: Icons.call, iconSize: 18,
              onTap: () => _soon(context)),
            const SizedBox(width: 8),
            _GlassCircleButton(icon: Icons.videocam_outlined, iconSize: 20,
              onTap: () => _soon(context)),
            const SizedBox(width: 8),
            _GlassCircleButton(icon: Icons.more_vert, iconSize: 20, onTap: onMore),
          ]),
      ),
    );
  }
